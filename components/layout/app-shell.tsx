  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F7F5F2] via-[#E8DDD3] to-[#F7F5F2]">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute left-[-6rem] top-[-4rem] h-64 w-64 rounded-full bg-[#00704A]/8 blur-3xl" />
        <div className="absolute bottom-[-6rem] right-[-3rem] h-72 w-72 rounded-full bg-[#1E3932]/6 blur-3xl" />
      </div>
